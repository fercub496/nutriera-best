...
export default function PrivacyPage() {
  return (
    /*<section className="min-h-screen bg-gray-100 py-20 px-4">*//*<div className="max-w-4xl mx-auto bg-white p-8 shadow-xl rounded-xl">*/
     <section className="max-w-3xl mx-auto px-4 py-16 text-gray-800">
       <h1 className="text-4xl font-bold text-green-700 mb-8 text-center">Política de Privacidad</h1>
        <div className="space-y-8 leading-relaxed">
            <p>En The Nutrition Era, valoramos tu privacidad. Esta política describe cómo recopilamos, usamos y protegemos tu información cuando visitas nuestro sitio web.</p>
